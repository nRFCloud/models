...
function validateProblem(problem: HttpProblem) {
    expect(problem.type.equals(new URLValue('http://example.com'))).toEqual(
        true,
    );
...
describe('HttpProblem', function() {
    ...
    describe('$context', () => {
        it('should exist', () => {
            expect(HttpProblem.$context.toString()).toEqual(
    ...
    describe('JSON', () => {
        it("should parse it's JSON representation", () => {
            const problem = HttpProblem.fromJSON(
                JSON.parse(
                    JSON.stringify(
                        new HttpProblem(
                            new URLValue('http://example.com'),
